...
export const ROUTE_DEFINITIONS: RouteDefinition[] = [
  {
    ...
    results: [
      ...
      {
        id: 'A3', label: '撤回并转走山谷', factHint: '降低即时风险；路线切换消耗已投入的三天',
  ...
  },
  {
    ...
    results: [
      ...
      {
        id: 'B3', label: '丢弃重型设备轻装前进', factHint: '争取截止前抵达；削弱后续开采能力',
        videoFile: 'route-b3-drop-equipment.mp4', videoTitle: '留下设备轻装前进',
        videoSynopsis: '队伍在截止前完成登记，却失去关键设备和后续开采能力。',
  ...
  },
  {
    ...
    situationSynopsis: '预报确认山脊即将封闭，左手略有恢复，但只剩十二天和一天半天气窗口。',
    choicePrompt: '答案已经有了，但窗口只剩一天半。队伍如何利用这条信息？',
  ...
  },
  {
    ...
    situationTitle: '撤离第二天：竞争者提出报价',
    situationFile: 'route-d-situation.mp4',
    situationSynopsis: '队伍开始打包撤离，风雪短暂减弱，同时收到竞争者购买矿区信息的报价。',
    choicePrompt: '团队决定保人，但还没有决定怎样退出。下一步怎么做？',
    ...
    results: [
      ...
      {
        id: 'D2', label: '出售勘探信息与优先权', factHint: '收回大部分投入；失去控制权和上涨收益',
        videoFile: 'route-d2-sell-information.mp4', videoTitle: '向竞争者出售勘探信息',
        videoSynopsis: '队伍安全撤离并收回大部分投入，但将未来矿区收益让给竞争者。',
        endingTitle: '退出被转化为现金，也转移了未来收益', endingSummary: '团队降低了风险并回收资本，同时永久失去矿区控制权。',
        metrics: { days: '安全撤离', people: '全员安全', capability: '资本大部回收', claim: '控制权出售' },
        lesson: '退出也可以创造价值，但机会成本会随未来上涨而扩大。',
      },
      {
        id: 'D3', label: '利用天气窗口重返矿区', factHint: '重新争取机会；反复转换消耗时间和补给',
        videoFile: 'route-d3-return.mp4', videoTitle: '趁天气窗口重新追赶',
        videoSynopsis: '队伍反转撤离战略重新追赶，因转换消耗时间和补给，最终只保住部分权益。',
        endingTitle: '战略反转追回机会，却付出了转换成本', endingSummary: '团队避免了彻底退出，但反复改变方向削弱了执行一致性。',
        metrics: { days: '最后时限', people: '疲劳明显', capability: '补给不足', claim: '保住部分权益' },
